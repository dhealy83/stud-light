  ...
  return (
    <nav className="navbar bg-secondary fixed-top">
      <div className="headEl container justify-content-between">
        <div className="">
          <button className="btn btn-secondary btn-outline-light" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample" fixed="bottom">
            <img src={sl} alt="Bootstrap" width="30" height="30" />
          </button>
        </div>
        <div className="headTitle">
          <Link to="/home" className="text-decoration-none">
            <span className="staatliches fs-1 text-center text-dark ">Stud Light</span>
          </Link>
        </div>
      </div>
      ...
      <div className="offcanvas offcanvas-start bg-light" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div className="m-2">
          <div>
            <Button variant="secondary" onClick={handleShow} className="mb-5 ms-3">
              Delete Account
            </Button>
          </div>
          ...
          <Modal show={show} onHide={handleClose}>
            ...
            <Modal.Body>Are you sure you'd like to delete your account?</Modal.Body>
            <Modal.Footer>
